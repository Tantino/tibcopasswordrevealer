...
#obfuscated_grp.add_option('-a', '--algorithm', help = 'Algorithm used (by default DES3-CBC)', nargs = 1)
...
def des3_cbc_decrypt(encrypted_password, decryption_key, iv):
    ...
    return decrypted_password.replace("\x00", '')
...
def unmangle_password(passwd):
    ...
    print "[+] unmangled password:\t%s" % unmangled_passwd
